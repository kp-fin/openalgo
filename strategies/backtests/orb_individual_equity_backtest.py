...
ATR_PERIOD = 14
OR_END = dtime(9, 45)          # opening range = 09:15-09:45 (first two 15m bars)
...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "orb_individual_equity")
...
result_df.to_csv(os.path.join(OUT_DIR, "orb_individual_equity_trades.csv"), index=False)
...
if result_df.empty:
    ...
    print(f"\nTrade log -> {OUT_DIR}/orb_individual_equity_trades.csv")
