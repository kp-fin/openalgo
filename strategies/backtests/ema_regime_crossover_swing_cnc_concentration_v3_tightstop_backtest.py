...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                        "ema_regime_crossover_swing_cnc_concentration_v3_tightstop")
...
result_df.to_csv(os.path.join(OUT_DIR, "ema_regime_crossover_swing_cnc_concentration_v3_tightstop_trades.csv"), index=False)
