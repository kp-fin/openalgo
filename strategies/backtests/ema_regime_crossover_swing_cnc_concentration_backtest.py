...
MAX_HOLD_DAYS = 20           # trading-day backstop if nothing else triggers
...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                        "ema_regime_crossover_swing_cnc_concentration")
...
result_df.to_csv(os.path.join(OUT_DIR, "ema_regime_crossover_swing_cnc_concentration_trades.csv"), index=False)
...
if result_df.empty:
    ...
    print(f"\nTrade log -> {OUT_DIR}/ema_regime_crossover_swing_cnc_concentration_trades.csv")
