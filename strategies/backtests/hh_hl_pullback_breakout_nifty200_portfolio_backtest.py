"""
HH-HL Pullback Breakout (Flag Continuation) -- Nifty 200, PORTFOLIO-CONSTRAINED
...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "hh_hl_pullback_breakout_nifty200_portfolio")
...
trades_df.to_csv(os.path.join(OUT_DIR, "hh_hl_pullback_breakout_nifty200_portfolio_trades.csv"), index=False)
...
print(f"\n=== HH-HL Pullback Breakout -- Nifty 200, PORTFOLIO-CONSTRAINED "
...
print(f"\nTrade log -> {OUT_DIR}/hh_hl_pullback_breakout_nifty200_portfolio_trades.csv")
